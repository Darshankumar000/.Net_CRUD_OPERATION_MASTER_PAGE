<%@ Page Title="" Language="C#" MasterPageFile="~/HDFC.Master" AutoEventWireup="true" CodeBehind="UpdateApplication.aspx.cs" Inherits="CRUD_HDFC_LOAN.UpdateApplication" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center>
        <table cellSpacing="5">
            <tr>
                <th colspan="2"><h1>UPDATE LOAN APPLICATION</h1></th>
            </tr>
            <tr>
             ...
             <tr>
                <th colspan="2">
                    <asp:Button ID="btnupdateApplication" runat="server" Text="Update Application" OnClick="btnupdateApplication_Click"  />
                </th>
            </tr>
        </table>
    </center>
